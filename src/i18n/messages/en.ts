...
export const enMessages = {
  ...
  me: {
    ...
    missions: {
      ...
      "main-gate-1": { title: "Main Gate Checkpoint 1", location: "Main gate approach" },
      "main-gate-2": { title: "Main Gate Checkpoint 2", location: "Main gate plaza" },
      "main-gate-3": { title: "Main Gate Checkpoint 3", location: "Inside main gate" },
      "main-gate-route": { title: "Main gate route completed", location: "Main gate 1-2-3" },
  ...
  scan: {
    ...
    checkpointLabel: "Checkpoint {current}/{total}",
    checkpointReward: "Route reward {points}",
    checkpointConfirm: "Verify checkpoint",
    checkpointConfirming: "Processing…",
    checkpointStepDone: "Checkpoint {current}/{total} complete",
    checkpointCompleted: "Route complete! {points} earned",
    checkpointAlready: "You already completed this route today.",
    checkpointAlreadyStep: "You already verified this checkpoint.",
    checkpointOutOfOrder: "Wrong order. Verify the previous checkpoint first.",
    checkpointInvalid: "This checkpoint is no longer usable.",
  },
  status: {
    neutral: "neutral",
    overuse: "overuse",
